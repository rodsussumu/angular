...
export class AuthLoginComponent implements OnInit {
  ...
  constructor() {
    ...
    this.exampleForm = new FormGroup({
      ...
      age_input: new FormControl(1, [Validators.required , Validators.min(1), Validators.max(2)]),
  ...
  myFunction(){
    ...
    console.log("Valor do campo name_input", this.exampleForm.get("name_input").value)

    // Exibindo se um campo é válido
    console.log("Campo name_input é válido?", this.exampleForm.get("name_input").valid)

    // Exibindo erros de um campo
    console.log("Erros no campo name_input", this.exampleForm.get("name_input").valid)
